...
export enum MESSAGE_SCHEDULER_TYPE {
	CAMPAIGN = 'CAMPAIGN',
	SCHEDULER = 'SCHEDULER',
	REPETITIVE_SCHEDULER = 'REPETITIVE_SCHEDULER',
	BOT = 'BOT',
...
export enum BOT_TRIGGER_OPTIONS {
	...
	ANYWHERE_MATCH_CASE = 'ANYWHERE_MATCH_CASE',
	ANYWHERE_IGNORE_CASE = 'ANYWHERE_IGNORE_CASE',
}
...
export enum TASK_TYPE {
	...
	EXPORT_GROUP_LINK_DETAILS = 'EXPORT_GROUP_LINK_DETAILS',
...
export const CACHE_TIMEOUT = 30 * 24 * 60 * 60; //seconds
