...
import { API_KEY, API_NAME, API_PAGE } from '../../../assets/Images';
		...
		<div>
			...
			<section className='p-6 md:px-[5%]'>
				<section id='heading' className=' pt-[70px]'>
					<h1 className='text-primary text-2xl md:text-4xl font-bold'>Whatsleads API</h1>
				</section>
				<div>
				...
				<section id='terms' className='grid grid-cols-1 md:grid-cols-2 justify-center items-end'>
					<div className='flex flex-col justify-between gap-4'>
						...
						<img src={API_PAGE} alt='API' width={1200} height={1200} className='md:w-3/4 mx-auto' />
					</div>
					<div className='flex flex-col justify-between gap-4'>
						<p className='text-lg pt-4'>3. Enter a name for key.</p>
						<img src={API_NAME} alt='API' width={1200} height={1200} className='md:w-3/4 mx-auto' />
					</div>
					<div className='md:col-span-2'>
						<p className='text-lg pt-4'>4. This token will be used for authentication.</p>
						<img src={API_KEY} alt='API' width={1200} height={1200} className='md:w-3/4 mx-auto' />
